...
export const mockAuthAccounts: AuthAccount[] = [
  {
    id: "auth-lgu-panglao",
    email: "sbpanglao@gmail.com",
    password: "sbpanglao123",
    name: "Maria Santos Cruz",
    portal: "lgu",
    userId: "user-lgu-panglao",
  },
  {
    id: "auth-company-admin",
    email: "legisdoc@gmail.com",
    password: "legisdoc123",
    name: "LegisDoc Admin",
    portal: "company",
  },
];
...
export const mockUsers: User[] = [
  {
    ...
    role: "sb_secretary",
    isActive: true,
    lastLogin: new Date("2026-07-01T08:00:00"),
    createdAt: new Date("2025-07-01"),
    moduleAccess: ["ordinances", "resolutions", "minutes", "categories"],
    allowedCategories: [],
  },
  {
    id: "user-1",
  ...
  },
  {
    ...
    position: "Digitization Assistant",
    mobile: "09178889900",
...
// Document Requests for admin table demo
export const mockDocumentRequests = [
  {
    id: "req-1",
    dateRequested: new Date("2026-04-01"),
    name: "Juan Dela Cruz",
    email: "juan.delacruz@email.com",
    office: "Tourism Office, Panglao",
    purpose: "Research",
    fileType: "Ordinance",
    documentNumber: "2025-01",
    title: "An Ordinance Regulating the Operation of Tourist Transport Services in the Municipality of Panglao",
    category: "Tourism",
  },
  {
    id: "req-2",
    dateRequested: new Date("2026-04-02"),
    name: "Maria Santos",
    email: "maria.santos@email.com",
    office: "SB Secretary Office",
    purpose: "Legal Reference",
    fileType: "Resolution",
    documentNumber: "2025-02",
    title: "A Resolution Requesting the DPWH to Expedite the Construction of the Panglao Bypass Road",
    category: "Infrastructure",
  },
  {
    id: "req-3",
    dateRequested: new Date("2026-04-03"),
    name: "Ana Reyes",
    email: "ana.reyes@email.com",
    office: "Barangay Tawala",
    purpose: "Personal Copy",
    fileType: "Ordinance",
    documentNumber: "2024-03",
    title: "An Ordinance Establishing the Municipal Scholarship Program for Underprivileged Youth",
    category: "Education",
  },
  {
    id: "req-4",
    dateRequested: new Date("2026-04-04"),
    name: "Roberto Gonzales",
    email: "roberto.g@email.com",
    office: "Legal Office, Panglao",
    purpose: "Court Submission",
    fileType: "Resolution",
    documentNumber: "2024-04",
    title: "A Resolution Confirming the Appointment of Members to the Municipal Tourism Council",
    category: "Tourism",
  },
  {
    id: "req-5",
    dateRequested: new Date("2026-04-05"),
    name: "Patricia Lim",
    email: "patricia.lim@email.com",
    office: "Tourism Establishment",
    purpose: "Business Permit",
    fileType: "Ordinance",
    documentNumber: "2025-05",
    title: "An Ordinance Approving the Annual Budget of the Municipality of Panglao for Fiscal Year 2026",
    category: "Budget",
  },
  {
    id: "req-6",
    dateRequested: new Date("2026-04-06"),
    name: "Liza Tan",
    email: "liza.tan@email.com",
    office: "Barangay Alona",
    purpose: "Barangay Records",
    fileType: "Resolution",
    documentNumber: "2025-06",
    title: "A Resolution Endorsing the Creation of Marine Protected Areas Along the Panglao Coastline",
    category: "Environment",
  },
  {
    id: "req-7",
    dateRequested: new Date("2026-04-07"),
    name: "Francis Delambaca",
    email: "francis.d@email.com",
    office: "SB Member",
    purpose: "Committee Review",
    fileType: "Ordinance",
    documentNumber: "2024-07",
    title: "An Ordinance Mandating the Establishment of Barangay-Level Disaster Preparedness Committees",
    category: "Peace and Order",
  },
  {
    id: "req-8",
    dateRequested: new Date("2026-04-08"),
    name: "Daisy Delambaca",
    email: "daisy.d@email.com",
    office: "Vice Mayor's Office",
    purpose: "Legislative Tracking",
    fileType: "Resolution",
    documentNumber: "2024-08",
    title: "A Resolution Expressing Gratitude to the Japan International Cooperation Agency for the Technical Assistance on Waste Management",
    category: "Environment",
  },
  {
    id: "req-9",
    dateRequested: new Date("2026-04-09"),
    name: "Alfonso Alcala",
    email: "alfonso.a@email.com",
    office: "Committee on Education",
    purpose: "Research",
    fileType: "Ordinance",
    documentNumber: "2024-09",
    title: "An Ordinance Providing Tax Incentives for Local Businesses Employing Persons with Disabilities",
    category: "Women and Children / PWD / Senior Citizen",
  },
  {
    id: "req-10",
    dateRequested: new Date("2026-04-10"),
    name: "Amira Caindec",
    email: "amira.c@email.com",
    office: "Committee on Health",
    purpose: "Committee Report",
    fileType: "Resolution",
    documentNumber: "2024-10",
    title: "A Resolution Declaring the Month of June as Environmental Awareness Month in the Municipality",
    category: "Environment",
  },
  {
    id: "req-11",
    dateRequested: new Date("2026-04-11"),
    name: "Analyn Casane",
    email: "analyn.c@email.com",
    office: "Committee on Budget",
    purpose: "Budget Review",
    fileType: "Ordinance",
    documentNumber: "2024-11",
    title: "An Ordinance Establishing the Municipal Road Improvement and Maintenance Program",
    category: "Infrastructure",
  },
  {
    id: "req-12",
    dateRequested: new Date("2026-04-12"),
    name: "Zinon Labaya",
    email: "zinon.l@email.com",
    office: "Committee on Peace & Order",
    purpose: "Committee Review",
    fileType: "Resolution",
    documentNumber: "2024-12",
    title: "A Resolution Approving the Annual Investment Plan of the Municipality of Panglao for Fiscal Year 2024",
    category: "Budget",
  },
  {
    id: "req-13",
    dateRequested: new Date("2026-04-13"),
    name: "Albert Bompat",
    email: "albert.b@email.com",
    office: "Committee on Environment",
    purpose: "Environmental Compliance",
    fileType: "Ordinance",
    documentNumber: "2024-13",
    title: "An Ordinance Regulating the Use of Single-Use Plastics Within the Municipality",
    category: "Environment",
  },
];
...
export const mockBillingOverview = {
  estimatedBalance: 4250.0,
  billingMonth: "July 2026",
  paymentDueDate: new Date("2026-08-05"),
  pastDueAmount: 0,
  paymentMethodLabel: "Mastercard ending in 5429",
};
...
export const mockInvoices = [
  {
    ...
    lineItems: [
      { description: "Legislative Management Platform — Annual Support", amount: 10000 },
      { description: "Document storage (45 GB)", amount: 1250 },
      { description: "Public portal hosting", amount: 1250 },
    ],
    subtotal: 12500,
    tax: 0,
    total: 12500,
  ...
  },
  {
    ...
    lineItems: [
      { description: "Legislative Management Platform — Annual Support", amount: 10000 },
      { description: "Document storage (42 GB)", amount: 1250 },
      { description: "Public portal hosting", amount: 1250 },
    ],
    subtotal: 12500,
    tax: 0,
  ...
  },
  {
    ...
    lineItems: [
      { description: "Legislative Management Platform — Annual Support", amount: 10000 },
      { description: "Document storage (40 GB)", amount: 1250 },
      { description: "Public portal hosting", amount: 1250 },
    ],
    subtotal: 12500,
    tax: 0,
...
export const mockBillingHistory = [
  {
    ...
    description: "Payment (Mastercard ending in 5429)",
    amount: -12500,
  },
  {
    id: "bh-2",
    ...
    description: "Invoice for June 2026",
    amount: 12500,
    invoiceId: "inv-june-2026",
  },
  {
    id: "bh-3",
  ...
  },
  {
    ...
    type: "invoice" as const,
    description: "Invoice for April 2026",
    amount: 12500,
    invoiceId: "inv-april-2026",
  },
];

export const mockLGUDepartmentProfile = {
  province: "Bohol",
  municipality: "Panglao",
  streetAddress: "Municipal Hall, Panglao, Bohol 6340",
  supportPlan: "annual" as const,
};
