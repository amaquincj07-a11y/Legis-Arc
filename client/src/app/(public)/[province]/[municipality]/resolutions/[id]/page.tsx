...
import { ResolutionDetailContent } from "../../../../resolutions/[id]/resolution-detail-content";
...
export async function generateMetadata({
  ...
  return lguPageMetadata(
    ...
    {
      pathRest: `/resolutions/${resolved.id}`,
      pageTitle: `Resolution — Sangguniang Bayan of ${name}`,
      pageDescription: `View resolution details and PDF from the Sangguniang Bayan of ${name}.`,
    }
  );
}
...
export default async function LguResolutionDetailPage({
  params,
}: {
  params: Promise<{ province: string; municipality: string; id: string }>;
}) {
